...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["data2@1.csv",new URL("./files/2374f7e62961a73b3d7fae55c7f09a806f774069384b01b9a63618f7b3fe884e699a69531403a1317ef41da64a76392f7ecae1805678bc6baf4816acbcd47b84",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# GlidePath Stacked Area Chart`
)});
...
d3.csvParse(await FileAttachment("data2@1.csv").text(), d3.autoType)
)});
